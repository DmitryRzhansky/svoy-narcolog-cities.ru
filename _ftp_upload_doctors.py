...
files = [
    "assets/images/doctors/morozov-ruslan.webp",
    "assets/images/doctors/beskova-anastasiya.webp",
    "assets/images/doctors/paramonov-sergey.webp",
    "assets/images/doctor-paramonov.webp",
    "assets/images/cta/paramonov.webp",
]
for p in LOCAL.rglob("*.html"):
    if ".git" in p.parts:
        continue
    t = p.read_text(encoding="utf-8")
    if "paramonov" in t or "beskova" in t or "morozov" in t:
